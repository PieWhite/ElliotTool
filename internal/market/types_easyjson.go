...
func easyjson6601e8cdDecodeWaveSightInternalMarket(in *jlexer.Lexer, out *Candle) {
...
func easyjson6601e8cdEncodeWaveSightInternalMarket(out *jwriter.Writer, in Candle) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Candle) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson6601e8cdEncodeWaveSightInternalMarket(&w, v)
...
func (v *Candle) UnmarshalJSON(data []byte) error {
	...
	easyjson6601e8cdDecodeWaveSightInternalMarket(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Candle) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson6601e8cdDecodeWaveSightInternalMarket(l, v)
}
